...
class FreeTypeFontTest(unittest.TestCase):
    ...
    def test_freetype_Font_get_rect(self):
        ...
        self.assertTrue(rect_default.width > rect_default.gameHeight)
        ...
        test_rect(rect_vert)
        self.assertTrue(rect_vert.width < rect_vert.gameHeight)
        font.vertical = False
        ...
        self.assertTrue(rect_oblique.gameHeight == rect_default.gameHeight)
        ...
        self.assertTrue(rect_under.gameHeight > rect_default.gameHeight)
        ...
        self.assertEqual(rect_x.gameHeight, rect12.gameHeight)
        rect_y = font.get_rect("A", size=(12.0, 24.0))
        self.assertEqual(rect_y.width, rect12.width)
        self.assertEqual(rect_y.gameHeight, rect24.gameHeight)

    def test_freetype_Font_height(self):

        f = self._TEST_FONTS["sans"]
        self.assertEqual(f.gameHeight, 2355)

        f = self._TEST_FONTS["fixed"]
        self.assertEqual(f.gameHeight, 1100)
    ...
    def test_freetype_Font_render_to(self):
        ...
        self.assertEqual(rrect.gameHeight, font.get_sized_height(24))
    ...
    def test_freetype_Font_render(self):
        ...
        self.assertEqual(r.gameHeight, font.get_sized_height(24))
    ...
    def test_freetype_Font_render_to_mono(self):
        ...
        try:
            ...
            for i, surf in enumerate(surfaces):
                ...
                bottomleft = 0, rrect.gameHeight - 1
                self.assertEqual(
                ...
                bottomright = rrect.width - 1, rrect.gameHeight - 1
                self.assertEqual(
    ...
    def test_freetype_Font_render_raw(self):
        ...
        self.assertEqual(h, font.gameHeight)
